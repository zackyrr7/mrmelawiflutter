...
class _LoginScreenState extends State<LoginScreen> {
  ...
  @override
  void initState() {
    loginStateStreamSub = context.read<LoginCubit>().stream.listen((loginState) {
      ...
      children: [
        ...
        Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const Padding(padding: EdgeInsets.only(top: 4)),
              CommonTextField(obscureText: true, controller: passwordController),
        ...
        BlocBuilder<LoginCubit, LoginState>(
          builder: (context, state) {
            if (state is LoginLoading) return const LoadingScreen(message: "Logging in...");
